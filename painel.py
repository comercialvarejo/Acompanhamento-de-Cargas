...
--------
  ...
  python3 scripts/painel.py exportar
      Tira as cargas que estão hoje no index.html e grava em dados/viagens.json.
...
SW = RAIZ / "sw.js"
JSON_PADRAO = RAIZ / "dados" / "viagens.json"
...
def main():
    ...
    e.add_argument("saida", nargs="?", help="arquivo de saída (padrão: dados/viagens.json)")
