 ...
 * da versão abaixo (CACHE). É isso que faz o celular de todo mundo baixar a
 * versão nova em vez de continuar mostrando a antiga.
 * O script scripts/painel.py já faz isso sozinho ao atualizar os dados.
 */
const CACHE = "painel-cargas-v1";
